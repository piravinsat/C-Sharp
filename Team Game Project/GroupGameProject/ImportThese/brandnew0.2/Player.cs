...
namespace MoonDefense
{
    ...
    class Player : IGameObject
    {
        ...
        public void Update(Game1 game)
        {
            ...
            {
                if (!isCarryingTower && (game.level.selectedTile.type == Tile.TileType.baseTile))
                {
                ...
                {
                    if (game.level.selectedTile.type != Tile.TileType.baseTile && game.level.selectedTile.isEmpty)
                    {
