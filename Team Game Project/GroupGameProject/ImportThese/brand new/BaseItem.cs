    ...
    public class BaseItem : Tile, IGameObject
    {
        ...
        public BaseItem(int i, int x, int y) : base(3, x, y)
        {
            switch (i){
                ...
                case 3: baseItemType = BaseItemTypes.tower4; destinationRectangle = new Rectangle(416, 608, 32, 32); break;
                case 4: baseItemType = BaseItemTypes.tower5; destinationRectangle = new Rectangle(384, 608, 32, 32); break;
        ...
        public void Draw(Microsoft.Xna.Framework.Graphics.SpriteBatch sb)
        {
            ...
            else if (baseItemType == BaseItemTypes.tower4) sb.Draw(ResourceManager.exampleTower, destinationRectangle, isSelected? Color.Green: Color.White);
            else if (baseItemType == BaseItemTypes.tower5) sb.Draw(ResourceManager.exampleTower, destinationRectangle, isSelected? Color.Green: Color.White);
            else if (baseItemType == BaseItemTypes.upgrade1) sb.Draw(ResourceManager.exampleTower, destinationRectangle, isSelected? Color.Green: Color.White);
            else if (baseItemType == BaseItemTypes.upgrade2) sb.Draw(ResourceManager.exampleTower, destinationRectangle, isSelected? Color.Green: Color.White);
        }
    }
}
