...
namespace MarsGame.Classes
{
    ...
    public class Mars
    {
        ...
        public Mars(GraphicsDevice device)
        {
            _device = device;
            //_table = table;
            ///set the radius
       ...
       // }
        ...
        public void LoadContent(ContentManager contentManager)
        {
            ...
            _marsTexture = contentManager.Load<Texture2D>("Textures/mars_1k_color");
        }
        ...
        public void Draw(GameTime gametime, Matrix view, Matrix projection)
        {
            ...
            {
                foreach (BasicEffect marsEffect in mesh.Effects)
                {
                    marsEffect.EnableDefaultLighting();
                    ...
                    marsEffect.View = view;
                    marsEffect.Projection = projection;
                    marsEffect.TextureEnabled = true;
                    marsEffect.Texture = _marsTexture;
                }
