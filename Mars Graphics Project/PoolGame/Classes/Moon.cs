...
namespace MarsGame.Classes
{
    ...
    public class Moon
    {
        ...
        public Moon(GraphicsDevice device, Model model, Texture2D texture, Vector3 position, float orbitSpeed)
        {
            _device = device;
            _model = model;
            _texture = texture;
        ...
        //    Velocity = new Vector3((float)_random.NextDouble() * InitialSpeed, (float)_random.NextDouble() * InitialSpeed, 0);
        // }
        ...
        public void Update(GameTime gametime)
        {
            ...
            angle = (totalTime / _orbitSpeed) * MathHelper.TwoPi;

           // if (gametime.ElapsedGameTime.Milliseconds == 0) return;
           // Angle += (1 / (float)gametime.ElapsedGameTime.Milliseconds) * MathHelper.PiOver4;
        ...
        public void Draw(GameTime gametime, Matrix view, Matrix projection)
        {
            ...
            {
                foreach (BasicEffect moonEffect in mesh.Effects)
                {
                    moonEffect.EnableDefaultLighting();
                    ...
                    moonEffect.View = view;
                    moonEffect.Projection = projection;
                    //Enables textures to be wrapped on Mars' moons
                    moonEffect.TextureEnabled = true;
                    //The addition of a texture is done here
                    moonEffect.Texture = _texture;
                }
